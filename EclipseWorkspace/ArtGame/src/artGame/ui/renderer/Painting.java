...
/**
 * A Painting asset. Behaves like a {@link Sprite}, but has a fixed position in
 * the world.
 * 
...
public class Painting implements Asset {
	...
	public Painting(Texture sprite, Matrix4f modelMatrix) {
		...
		vert = new Shader(GL_VERTEX_SHADER, AssetLoader.instance()
				.loadShaderSource("res/painting.vert"));
	...
	/**
	 * Creates a copy of the painting with the specified model matrix.
	 * 
	 * @param pos
	 *            The model matrix to use.
	 * @return A copy of the painting with the same texture and specified model
	 *         matrix.
	 */
